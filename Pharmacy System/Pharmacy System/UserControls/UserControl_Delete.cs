...
namespace Pharmacy_System.UserControls
{
    public partial class UserControl_Delete : UserControl
    {
        ...
        public void setLanguage(String Languagename)
        {
            ...
            switch (Languagename)
            {
                ...
                case "English":
                    ...
                    AddStore_button.Text = "Delete Store";
                    AddItem_button.Text = "Delete Item";
                    AddUnit_button.Text = "Delete Unit";
        ...
        {
            UpdateAndDelete.UpdateDeleteItem_Form updateDeleteItem_Form = new UpdateAndDelete.UpdateDeleteItem_Form(AddItem_button.BackgroundImage, "حذف مادة");
            updateDeleteItem_Form.ShowDialog();
        }

        private void AddUnit_button_Click(object sender, EventArgs e)
        {
            UpdateAndDelete.UpdateDeleteUnitItem_Form udateDeleteUnitItem_Form = new UpdateAndDelete.UpdateDeleteUnitItem_Form(AddItem_button.BackgroundImage, "حذف واحدة");
            udateDeleteUnitItem_Form.ShowDialog();
        }

        private void CustomerCard_button_Click(object sender, EventArgs e)
        {
            UpdateAndDelete.UpdateDeleteSupplier_Form updateDeleteSupplier_Form = new UpdateAndDelete.UpdateDeleteSupplier_Form(AddUnit_button.BackgroundImage, "حذف حساب زبون");
            updateDeleteSupplier_Form.ShowDialog();
        }

        private void SupplierCard_button_Click(object sender, EventArgs e)
        {
            UpdateAndDelete.UpdateDeleteSupplier_Form updateDeleteSupplier_Form = new UpdateAndDelete.UpdateDeleteSupplier_Form(AddUnit_button.BackgroundImage, "حذف حساب المورد");
            updateDeleteSupplier_Form.ShowDialog();
        }

        private void AccountCard_button_Click(object sender, EventArgs e)
        {
            UpdateAndDelete.UpdateDeleteReferenceCalculattion_Form updateDeleteReferenceCalculattion_Form = new UpdateAndDelete.UpdateDeleteReferenceCalculattion_Form(AddUnit_button.BackgroundImage, "حذف حساب المورد");
            updateDeleteReferenceCalculattion_Form.ShowDialog();
        }

        private void AddStore_button_Click(object sender, EventArgs e)
        {
            UpdateAndDelete.UpdateDeleteStore_Form updateDeleteStore_Form = new UpdateAndDelete.UpdateDeleteStore_Form(AddUnit_button.BackgroundImage, "حذف مستودع");
